...
# creating the window
window = glfw.create_window(1280, 680, "My OpenGL window", None, None)
...
cube1_texture = load_texture("textures/crate1.jpg", texture[0])
cube2_texture = load_texture("textures/anime_girl_PNG45.png", texture[1])

...
glfw.set_window_pos(window, 40, 20)
...
car_indices, car_buffer = ObjLoader.load_model("meshes/cars.obj")
...
car_pos = pyrr.matrix44.create_from_translation(pyrr.Vector3([-4, 0, 0]))
...
sw_loc = glGetUniformLocation(shader, "switcher")

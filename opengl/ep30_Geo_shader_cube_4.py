...
void build_cube(mat4 mx,vec4 pt)
{
    ...
    aNormal = vec3(-0.408248,0.816497,-0.408248);
    EmitVertex();
    gl_Position = mx * (position + vec4( l , l ,0.0,0.0));
    aNormal = vec3(0.408248,0.408248,-0.816497);
    EmitVertex();
    gl_Position = mx * (position + vec4(0.0,0.0,0.0,0.0));
    aNormal = vec3(-0.577350,-0.577350,-0.577350);
    EmitVertex();
    gl_Position = mx * (position + vec4( l ,0.0,0.0,0.0));
    aNormal = vec3(0.816497,-0.408248,-0.408248);
    EmitVertex();
